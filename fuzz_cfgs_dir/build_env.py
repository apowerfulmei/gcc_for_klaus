...
def crawl_information(syzid):
    ...
    commit_url = "https://git.kernel.org" + requests.get(patchlink).text.split("th>commit</th><td colspan='2' class='oid'><a href='")[1].split("'>")[0]
...
def compile_fuzzing_kernel(proj_dir):
    ...
    os.system("cd {}/linux_buggy_patched_for_fuzz && yes \"\" | DIST_DIR={} COND_FILE={}/cond.txt PROP_FILE={}/prop.txt make CC={} -j`nproc`".format(proj_dir, distance_dir,proj_dir, proj_dir, special_gcc))
